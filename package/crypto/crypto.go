 ...
 * private key: openssl ecparam -name prime256v1 -genkey -noout -out training_frontend_private_key.pem
 * public key: openssl pkey -in training_frontend_private_key.pem -pubout -out training_frontend_public_key.pem
