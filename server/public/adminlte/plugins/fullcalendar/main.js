    ...
    */
    ...
    var TableRow = /** @class */ (function (_super) {
        ...
        TableRow.prototype.componentDidUpdate = function (prevProps, prevState) {
            var curreNTrPops = this.props;
            this.updateSizing(!isPropsEqual(prevProps, curreNTrPops));
        };
    ...
    var TimeColsView = /** @class */ (function (_super) {
        ...
        /* Dimensions
        ------------------------------------------------------------------------------------------------------------------*/
        TimeColsView.prototype.getAllDayMaxEveNTrPops = function () {
    ...
    */
    ...
    var DayTimeColsView = /** @class */ (function (_super) {
        ...
        DayTimeColsView.prototype.render = function () {
            ...
            var allDayContent = (options.allDaySlot !== false) && (function (contentArg) { return (createElement(DayTable, __assign({}, splitProps.allDay, { dateProfile: dateProfile, dayTableModel: dayTableModel, nextDayThreshold: options.nextDayThreshold, tableMinWidth: contentArg.tableMinWidth, colGroupNode: contentArg.tableColGroupNode, renderRowIntro: hasAttachedAxis ? _this.renderTableRowAxis : null, showWeekNumbers: false, expandRows: false, headerAlignElRef: _this.headerElRef, clientWidth: contentArg.clientWidth, clientHeight: contentArg.clientHeight, forPrint: props.forPrint }, _this.getAllDayMaxEveNTrPops()))); });
