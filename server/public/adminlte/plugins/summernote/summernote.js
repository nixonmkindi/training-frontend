...
var Context_Context = /*#__PURE__*/function () {
  ...
  /**
   * create layout and initialize module and other resources
   */
  ...
  _createClass(Context, [{
    ...
    /**
     * destroy module and other resources and remove layout
     */
    ...
    /**
     * destory module and other resources and initialize it again
     */
    ...
    value: function _initialize() {
      ...
      var modules = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend({}, this.options.modules, external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote.plugins || {}); // add and initialize module
    ...
    value: function _destroy() {
      ...
      // destroy module with reversed order
...
// EXTERNAL MODULE: ./src/js/base/settings.js + 37 module
