!(function (t, e) {
  ...
  ((j = O || (O = {})).Initializing = "initializing"),
    (j.Loading = "loading"),
    (j.Error = "error"),
    (j.Show = "show"),
      ...
      return (
        (e.setModal = function (t) {
          var e = t.show,
            ...
            r = t.color,
            o = t.content;
          (this.modal.style.backgroundColor = void 0 === r ? "#FFFFFF" : r),
            (this.modal.style.display = n ? "flex" : "none"),
            o && (this.modal.innerHTML = o);
        }),
        ...
        (e.update = function (t) {
          if (
            ((null == t ? void 0 : t.url) && (this.options.url = t.url),
            ...
            f(t.data)
              ? (e = t.data)
              : ((null == t ? void 0 : t.background) ||
                  this.changeTo(O.Loading),
                (e = t.data()));
            var n = this.getDataFrom(e);
            return (
              this.changeTo(O.Show),
              t.background
                ? this.onBackgroundUpdate(n, null == t ? void 0 : t.additional)
                : this.onUpdate(n, null == t ? void 0 : t.additional)
            );
          }
          (null == t ? void 0 : t.background) || this.changeTo(O.Loading),
            this.request(t);
        }),
        (e.destroy = function () {
          this.onDestroy(),
            this.controller.remove(),
            this.changeTo(O.Destroyed);
        }),
        ...
        (e.onRawUpdate = function (t, e) {
          ...
          this.changeTo(O.Show),
            (null == e ? void 0 : e.background)
              ? this.onBackgroundUpdate(n, null == e ? void 0 : e.additional)
              : this.onUpdate(n, null == e ? void 0 : e.additional);
        }),
    ...
    P = (function (t) {
      ...
      return (
        ...
        (n.responsive = function (t) {
          return (
            void 0 === t && (t = !0),
            this.options({ options: { maintainAspectRatio: !t } })
          );
        }),
        (n.legend = function (t) {
          return (
            void 0 === t && (t = {}),
            "boolean" == typeof t && (t = { display: t }),
            this.options({ options: { legend: t } })
          );
        }),
        ...
        (n.padding = function (t) {
          return (
            void 0 === t && (t = 5),
            this.options({ options: { layout: { padding: t } } })
          );
        }),
          ...
          return (
            ...
            this.custom(function (n) {
              var r,
                i = n.data;
              if (
                ((i.type = "string" == typeof t ? t : e),
                Array.isArray(t) &&
                  (null === (r = i.data) || void 0 === r ? void 0 : r.datasets))
              ) {
        ...
        (n.tooltip = function (t) {
          return (
            "boolean" == typeof t && (t = { enabled: t }),
            this.options({ options: { tooltips: t } })
          );
        }),
    ...
    D = (function (t) {
      ...
      return (
        ...
        (r.renewCanvas = function () {
          this.canvas && this.body.removeChild(this.canvas),
        ...
        (r.onUpdate = function (t) {
          this.chart && this.chart.destroy(),
            this.renewCanvas(),
            (this.chart = new e(this.canvas, t));
        }),
          ...
          this.chart
            ? ((this.chart.options = o(o({}, this.chart.options), t.options)),
              this.chart.data.labels &&
                (null === (r = t.data) || void 0 === r ? void 0 : r.labels) &&
                n.mutateArray(this.chart.data.labels, t.data.labels),
        ...
        (r.toImage = function () {
          var t;
          return null === (t = this.chart) || void 0 === t
            ? void 0
            : t.toBase64Image();
        }),
        (r.legend = function () {
  ...
  "undefined" != typeof window &&
    ((window.Chartisan = D), (window.ChartisanHooks = P)),
    (t.Chartisan = D),
    (t.ChartisanHooks = P);
});
